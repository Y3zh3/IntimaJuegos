...
const challenges = [
    "Venda los ojos de tu pareja. Dale a probar tres alimentos diferentes (frutas, chocolate, etc.) y pídele que adivine qué son.",
    "Prepara un baño de burbujas sorpresa. No reveles nada, solo guía a tu pareja al baño.",
    "Elige una pluma, un cubito de hielo y un trozo de seda. Pasa cada objeto suavemente por la espalda de tu pareja y pídele que describa las sensaciones.",
    "Prepara un masaje de manos con un aceite aromático. Concéntrate en la presión y en cada nudillo.",
    "Pon música sensual y bailen juntos en la oscuridad, sintiendo solo el movimiento del otro.",
    "Susúrrale al oído a tu pareja tres cosas que te encantan de su cuerpo.",
    "Escriban con los dedos palabras de amor en la espalda del otro y traten de adivinarlas.",
    "Darse de comer el uno al otro una fruta jugosa como fresas o mangos, lentamente.",
    "Tomen una ducha juntos y laven el cabello del otro con cuidado y delicadeza.",
    "Acuéstense en silencio y traten de sincronizar su respiración mientras se miran a los ojos."
];

export default function DesafioDeLosSentidosPage() {
    ...
    <div className="flex flex-col min-h-screen w-full bg-background font-body">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 bg-muted/20">
        <div className="w-full max-w-2xl text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-primary">Desafío de los Sentidos</h1>
            <p className="text-muted-foreground mt-2">Agudicen sus sentidos y redescubran el placer.</p>
        </div>
